...
<br><br>
				...
				<div class="col-md-6 contact-form">
						<h4 class="white-w3ls">Login <span>Now</span></h4>
						<form action="#" method="post"> 
							<input type="text" placeholder="Enter your username" name="username" required="true" style="color: #000;background:#fff;border: none;"><br><br><br>
							<input type="text" placeholder="Enter your password" name="password" required="true"  style="color: #000;background:#fff;border: none;"><br><br><br>
							<input type="submit" @click.stop.prevent="submit()" value="Send">
						</form>
					</div>
