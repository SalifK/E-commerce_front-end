...
#PPMiniCart .minicart-submit::after {
	/*display: none;*/
...
.link-product-add-cart:hover {
    background: #51da2f none repeat scroll 0 0;
    color: #fff;
}
/*-- //effect --*/
...
<br><br>
				...
				<div class="col-md-6 contact-form">
						<h4 class="white-w3ls">Sign in <span>Now</span></h4>
						<form action="#" method="post"> 
							...
							<input type="text" placeholder="Enter your last name" name="last_name" required="true"  style="color: #000;background:#fff;border: none;"><br><br><br>
							<input type="text" placeholder="Enter you username" name="username" required="true"  style="color: #000;background:#fff;border: none;"><br><br><br>
							<input type="text" placeholder="Enter your email" name="email" required="true"  style="color: #000;background:#fff;border: none;"><br><br><br>
							<input type="password" placeholder="Enter your password" name="password" required="true"  style="color: #000;background:#fff;border: none;"><br><br><br>
							
							<input type="submit" @click.stop.prevent="submit()" value="Register" >
						</form>
					</div>
